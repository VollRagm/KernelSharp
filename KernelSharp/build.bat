...
csc.exe /nologo /debug:embedded /noconfig /nostdlib /runtimemetadataversion:v4.0.30319 Program.cs WDK.cs Runtime/InteropServices.cs Runtime/CompilerHelpers.cs Runtime/CompilerServices.cs Runtime/System.cs Runtime/Runtime.cs /out:Program.ilexe /langversion:latest /unsafe || goto Error
